...
const Navbar = () => {
  ...
  const handleSelectResult = useCallback(
    (result: Movie & { media_type?: string }) => {
  ...
  return (
    <nav
      className="fixed top-3 left-2 right-2 z-50"
      style={{
    ...
    >
      <div className="flex items-center justify-between gap-6 px-4 md:px-8 lg:px-14 py-3.5">
        ...
        <div className="flex justify-between gap-4">
          ...
          <form
            ...
            className="flex-1 max-w-xs ml-auto md:ml-0"
          >
            <div className="relative" ref={dropdownRef}>
              <input
                ...
                className="w-full px-4 py-2 text-sm text-white placeholder-on-surface-variant rounded-3xl focus:outline-none transition-all"
                style={{
                  background: "#201f1f",
              ...
              {showDropdown && (
                ...
                >
                  {loading ? (
                    ...
                    results
                      .slice(0, 8)
                      .map((result: Movie & { media_type?: string }) => (
                        <div
                          key={result.id}
                          onClick={() => handleSelectResult(result)}
                          className="px-4 py-3 cursor-pointer transition-colors flex gap-3 items-start hover:bg-surface-highest"
                        >
                          {result.poster_path && (
                            <img
