             ...
             {totalPages > 1 && (
               <div className="flex justify-center items-center gap-4 mt-12 mb-8">
                 <button
                   ...
                   className="px-2 md:px-4 py-2 md:py-2 bg-red-600 hover:bg-red-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white rounded-lg font-semibold transition-colors"
                 >
                   Previous
                 </button>
                   ...
                   {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                     ...
                     return (
                       <button
                         ...
                         className={`px-1.5 md:px-3 py-1 md:py-2 rounded-lg font-semibold transition-colors ${
                           currentPage === pageNum
