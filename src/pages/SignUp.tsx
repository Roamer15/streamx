...
const SignUp = () => {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#0e0e0e" }}>
        <div className="w-full max-w-md rounded-2xl p-8 text-center" style={cardStyle}>
          <div
            className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5"
            style={{ background: "rgba(255,141,143,0.12)", border: "1px solid rgba(255,141,143,0.3)" }}
          >
            <svg className="w-8 h-8" style={{ color: "#ff8d8f" }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h2 className="text-white text-xl font-bold mb-2" style={{ fontFamily: "'Manrope', sans-serif" }}>
            Check your email
          </h2>
          <p className="text-sm mb-6 leading-relaxed" style={{ color: "#adaaaa" }}>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#0e0e0e" }}>
      <div className="w-full max-w-md rounded-2xl p-8" style={cardStyle}>
        {/* Logo */}
        <div className="text-center mb-8">
          <Link to="/">
            <span className="text-3xl font-extrabold tracking-tight" style={{ fontFamily: "'Manrope', sans-serif" }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm mb-1.5 font-medium" style={{ color: "#adaaaa" }}>Email</label>
            <input
              type="email"
              required
              value={email}
          ...
          <div>
            <label className="block text-sm mb-1.5 font-medium" style={{ color: "#adaaaa" }}>Password</label>
            <input
              type="password"
              required
              value={password}
          ...
          <div>
            <label className="block text-sm mb-1.5 font-medium" style={{ color: "#adaaaa" }}>Confirm Password</label>
            <input
              type="password"
              required
              value={confirm}
        ...
        <p className="text-center text-sm mt-6" style={{ color: "#484847" }}>
          ...
          <Link to="/login" className="font-semibold" style={{ color: "#ff8d8f" }}>
            Sign in
          </Link>
        </p>
      </div>
